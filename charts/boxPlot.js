(function(){
  ...
  var chart = raw.chart()
		.title("Box plot")
		.description("Un graphique en boîte et moustaches utilise des glyphes simples qui résument une distribution quantitative avec cinq statistiques standard: la plus petite valeur, le quartile inférieur, la médiane, le quartile supérieur et la valeur la plus élevée.<br>Basé sur <a href='https://bl.ocks.org/mbostock/4061502'>https://bl.ocks.org/mbostock/4061502</a>")
