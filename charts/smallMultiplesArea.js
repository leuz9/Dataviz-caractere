(function(){
    ...
    var chart = raw.chart()
        .title('Graphique de surface')
        .thumbnail("imgs/smallMultiples.png")
        .description("Un petit multiple est une série de petits graphiques ou graphiques similaires, leur permettant d'être facilement comparés. <br/> Basé sur <a href='http://bl.ocks.org/mbostock/9490313'> http: // bl.ocks.org/mbostock/9490313</a>")
