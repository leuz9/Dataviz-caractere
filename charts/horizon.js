! function () {
    ...
    var chart = raw.chart()
        .model(model)
        .title('Graphique d'horizon')
        .thumbnail("imgs/horizon.png")
        .description("Les graphiques Horizon combinent position et couleur pour réduire l'espace vertical. <br/> <br/> Basé sur <a href='http://bl.ocks.org/mbostock/1483226'> http://bl.ocks.org / mbostock / 1483226</a>")
