(function(){
    ...
    var chart = raw.chart()
        ...
        .description(
            "Les coordonnées parallèles sont un moyen courant de visualiser la géométrie de haute dimension et d'analyser les données multivariées. Pour afficher un ensemble de points dans un espace à n dimensions, un fond est constitué de n lignes parallèles, typiquement verticales et équidistantes. Un point dans l'espace à n dimensions est représenté par une polyligne avec des sommets sur les axes parallèles; la position du sommet sur le ième axe correspond à la ième coordonnée du point. <br/> D'après <a href='http://bl.ocks.org/jasondavies/1341281'> http://bl.ocks.org/jasondavies/1341281</a>")
