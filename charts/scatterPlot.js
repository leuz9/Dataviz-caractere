(function(){
	...
	var chart = raw.chart()
		.title('Scatter Plot')
		.description(
            "Un diagramme de dispersion est un type de diagramme mathématique utilisant des coordonnées cartésiennes pour afficher des valeurs pour deux variables pour un ensemble de données. Les données sont affichées sous la forme d'une collection de points, chacun ayant la valeur d'une variable déterminant la position sur l'axe horizontal et la valeur de l'autre variable déterminant la position sur l'axe vertical. Ce type de tracé est également appelé diagramme de dispersion.")
