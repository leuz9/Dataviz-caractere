(function () {
    ...
    var chart = raw.chart()
        .title('Enveloppe convexe')
        .description(
            "En mathématiques, la <a href='https://en.wikipedia.org/wiki/Convex_hull'> coque convexe </a> est la plus petite forme convexe contenant un ensemble de points. Appliqué à un nuage de points, il est utile d'identifier les points appartenant à la même catégorie. <br /> <br/> Basé sur <a href='http://bl.ocks.org/mbostock/4341699'> http: / /bl.ocks.org/mbostock/4341699</a>")
