(function(){
	...
	var chart = raw.chart()
        .title('rayon de soleil(Sunburst)')
		.description(
            "Un l est similaire au treemap, sauf qu'il utilise une disposition radiale. Le nœud racine de l'arbre est au centre, avec des feuilles sur la circonférence. La zone (ou l'angle, en fonction de l'implémentation) de chaque arc correspond à sa valeur. <br/> Basé sur <a href='http://bl.ocks.org/mbostock/4063423'> http: // bl. ocks.org/mbostock/4063423</a>")
