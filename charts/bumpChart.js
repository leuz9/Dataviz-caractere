(function(){
    ...
    var chart = raw.chart()
        .title('Graphique Bump')
        .thumbnail("imgs/bumpChart.png")
        .description(
            "Pour les données continues telles que les séries chronologiques, un graphique de relief peut être utilisé à la place des barres empilées. Basé sur la <a href='http://www.nytimes.com/interactive/2014/08/13/upshot/where-people-in-each-state-were-born.html'> visualisation interactive du New York Times.</a>")
