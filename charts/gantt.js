(function(){
    ...
    var chart = raw.chart()
        .title('Diagramme de Gantt')
				...
				.description("Un diagramme de Gantt est un type de graphique à barres, développé par Henry Gantt dans les années 1910, qui illustre un calendrier de projet. Les diagrammes de Gantt illustrent les dates de début et de fin des éléments terminaux et des éléments récapitulatifs d'un projet.")
