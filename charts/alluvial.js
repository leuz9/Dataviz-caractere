(function(){
	...
	var chart = raw.chart()
		...
		.description(
            "Les diagrammes alluviaux permettent de représenter les flux et de voir les corrélations entre les dimensions catégorielles, en les reliant visuellement au nombre d'éléments partageant les mêmes catégories, il est utile de voir l'évolution du cluster (comme le nombre de personnes appartenant à un groupe spécifique). Il peut également être utilisé pour représenter des graphes bipartites, en utilisant chaque groupe de nœuds comme dimensions. <br/> Principalement basé sur le travail de DensityDesign avec Fineo, il est inspiré par <a href='http://bost.ocks.org/mike/sankey/'>http://bost.ocks.org/mike/sankey/</a>")
